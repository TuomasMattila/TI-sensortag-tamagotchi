...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/bin/armcl" -mv7M3 --code_state=16 --float_support=vfplib -me --include_path="C:/Users/tuoma/Documents/Opiskelu_repot/Johdatus_tietokonejarjestelmiin/Jtkj-harjoitustyo" --include_path="C:/Users/tuoma/Documents/Opiskelu_repot/Johdatus_tietokonejarjestelmiin/Jtkj-harjoitustyo" --include_path="C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc26xxware_2_24_03_17272" --include_path="C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/include" --define=ccs -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-486622287:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-486622287-inproc

build-486622287-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-486622287 ../empty.cfg
configPkg/compiler.opt: build-486622287
configPkg/: build-486622287
